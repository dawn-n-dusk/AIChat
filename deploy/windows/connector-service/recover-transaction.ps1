...
Write-Host "task_mode=$($result.task_mode)"
Write-Host "task_untouched=$($result.task_untouched.ToString().ToLowerInvariant())"
Write-Host "task_scheduler_accessed=$($result.task_scheduler_accessed.ToString().ToLowerInvariant())"
